function [dM,indv,inds,trtm,tfm] = processShotRecordsOnGpu(v,shot,ixs,ixwin,nxwin,ntr,nnz,nnx,nnr,nnt,dsx,dx,dt,ss)
...
% common indicies
ix   = gpuArray(2:nx-1);       % interior x
ixb  = gpuArray(1:20);         % boundary x (right)
...
snapshot = zeros(nz,nx,nt,'gpuArray');
