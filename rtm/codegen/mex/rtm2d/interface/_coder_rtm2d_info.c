...
static void b_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1311262518U), "fileTimeLo", 83);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m"),
                "resolved", 84);
  emlrtAddField(*info, b_emlrt_marshallOut(1378303184U), "fileTimeLo", 84);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m"),
                "resolved", 87);
  emlrtAddField(*info, b_emlrt_marshallOut(1323174178U), "fileTimeLo", 87);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                "resolved", 89);
  emlrtAddField(*info, b_emlrt_marshallOut(1363718156U), "fileTimeLo", 89);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("rtm2d"));
...
/* End of code generation (_coder_rtm2d_info.c) */
