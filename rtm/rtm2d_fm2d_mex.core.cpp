...
void rtm2d_fm2d(double *v, double *data,double *boundary, double* M, int64 nz, int64 nx, int64 nt, double dt, double dx);
...
#pragma omp for
		for (int64 ix = 0; ix < 20; ix++)
		{
#pragma simd
			for (int64 iz = 0; iz < bz; iz++)
			{
