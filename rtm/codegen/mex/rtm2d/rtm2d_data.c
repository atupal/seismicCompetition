 ...
 * rtm2d_data.c
 *
 * Code generation for function 'rtm2d_data'
 *
 */
...
emlrtRSInfo f_emlrtRSI = { 79, "colon",
  "/matlab/toolbox/eml/lib/matlab/ops/colon.m" };

emlrtRSInfo g_emlrtRSI = { 283, "colon",
  "/matlab/toolbox/eml/lib/matlab/ops/colon.m" };

rtm2dStackData *rtm2dStackDataLocal;

/* End of code generation (rtm2d_data.c) */
