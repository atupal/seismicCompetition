...
MATLAB_ROOT = /matlab
MAKEFILE = fm2d_mex.mk

include fm2d_mex.mki
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/fm2d"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/fm2d/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/fm2d/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/fm2d/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/fm2d/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
