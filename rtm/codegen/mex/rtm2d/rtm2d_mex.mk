...
MEX_FILE_NAME_WO_EXT = rtm2d_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rtm2d"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rtm2d/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rtm2d/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rtm2d/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rtm2d/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
